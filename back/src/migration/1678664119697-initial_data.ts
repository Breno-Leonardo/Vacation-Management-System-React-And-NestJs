...
export class initialData1678664119697 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    queryRunner.query(`
        ...
        VALUES('0', 'Gestor Master', '11111111111', '$2b$10$ct1gI7WihgL9TRe0RF0j5eCf0GnKaGiR.mvI0/oXdTBxnL9nM3I9i', 'Gestor Master', 'gestorMaster@verdecard.com.br', 'gestorMaster@gmail.com', '1980-01-01', 0, 'CLT', '2024-01-01');
