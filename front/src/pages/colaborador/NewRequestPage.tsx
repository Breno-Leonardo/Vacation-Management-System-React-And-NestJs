        ...
        <Container title="Solicitação">
          <div className={styles.infos}>
            <div className={styles.infosContent}>
              ...
              <Input icon={calendar} placeholder="dd/mm/aaaa" type="date" size="Medium" width="Medium"></Input>

            </div>
            <div className={styles.infosContent}>
              <span>Dias</span>
              <Select size="Medium" width="Medium" optionsUnique={[5,10,15,20,30]}></Select>
            </div>
            <div className={styles.infosContent}>
              <span>Data de Término</span>
              <Input icon={calendar} placeholder="Insira o início" type="text" size="Medium" width="Medium" disabled={true}></Input>
            </div>
          </div>
